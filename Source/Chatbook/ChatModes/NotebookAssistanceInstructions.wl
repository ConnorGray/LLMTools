...
loadNotebookAssistanceInputs[ ] := Enclose[
    Module[ { as },
        as = ConfirmBy[ AssociationMap[ loadNotebookAssistanceInput, $codeAssistanceInputKeys ], AssociationQ, "Inputs" ];
        WithCleanup[
...
loadNotebookAssistanceInput[ name: $$codeAssistanceInputKey ] := Enclose[
